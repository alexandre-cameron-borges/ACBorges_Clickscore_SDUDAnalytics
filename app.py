...
st.markdown('''Le :rainbow[DUDA Clickscore] est le **MVP d'une Webapp streamlit de Clickscoring réalisée pour le DU Panthéon Sorbonne Data Analytics 2025-2026 par Alexandre Cameron BORGES**.  
